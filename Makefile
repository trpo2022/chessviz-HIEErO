...
obj/src/libchessviz/libchess.a: obj/src/libchessviz/check_mate.o obj/src/libchessviz/find_figure.o obj/src/libchessviz/move.o obj/test/test.o
	ar src $@ $^

obj/src/libchessviz/check_mate.o: src/libchessviz/check_mate.c
	gcc -c $(CFLAGS) $(CPPFLAGS) -I src/ -o $@ src/libchessviz/check_mate.c

obj/src/libchessviz/find_figure.o: src/libchessviz/find_figure.c
	gcc -c $(CFLAGS) $(CPPFLAGS) -I src/ -o $@ src/libchessviz/find_figure.c
